            ...
            switch (_d.label) {
                ...
                case 1:
                    ...
                    if (checkSignature &&
                        ...
                        _b = libsaml_1.default.verifySignature(samlContent, verificationOptions), verified = _b[0], verifiedAssertionNode = _b[1];
                        if (!verified) {
                    ...
                    if (!(parserType === 'SAMLResponse' && decryptRequired)) return [3 /*break*/, 3];
                ...
                case 3:
                    ...
                    if (checkSignature &&
                        ...
                        _c = libsaml_1.default.verifySignature(samlContent, verificationOptions), verified = _c[0], verifiedAssertionNode = _c[1];
                        if (verified) {
                            extractorFields = getDefaultExtractorFields(parserType, verifiedAssertionNode);
                        }
                        else {
